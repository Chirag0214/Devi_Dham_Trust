            ...
            <div class="space-y-4">
              <div class="relative">
                ...
                <input v-model="loginForm.email" id="login-email-address" name="email" type="email" autocomplete="email" required 
                       class="w-full pl-10 pr-3 py-3 border border-gray-200 rounded-md placeholder-gray-500 text-gray-900 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 sm:text-sm" 
      ...
      <input v-model="loginForm.password" id="login-password" name="password" :type="showPassword ? 'text' : 'password'" autocomplete="current-password" required 
        class="w-full pl-10 pr-3 py-3 border border-gray-200 rounded-md placeholder-gray-500 text-gray-900 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 sm:text-sm" 
              ...
              <div class="flex items-center mt-2">
                <input id="show-password" type="checkbox" v-model="showPassword" class="h-4 w-4 text-brand-500 focus:ring-brand-500 border-gray-300 rounded" />
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <input id="remember-me" type="checkbox" class="h-4 w-4 text-brand-500 focus:ring-brand-500 border-gray-300 rounded" />
                <label for="remember-me" class="ml-2 block text-sm text-gray-600">Remember me</label>
              </div>
              <div class="text-sm">
                <a href="#" class="font-medium text-brand-500 hover:text-brand-400">
          ...
          <p class="mt-2 text-center text-sm text-gray-600">
            ...
            <router-link to="/signup" class="font-medium text-brand-600 hover:text-brand-500 focus:outline-none">
              Sign up
            </router-link>
          </p>
        </div>
...
import { ref } from 'vue';
import { UserCircleIcon, EnvelopeIcon, LockClosedIcon } from '@heroicons/vue/24/solid';
