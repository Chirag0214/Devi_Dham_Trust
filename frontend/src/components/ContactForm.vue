    ...
    <form @submit.prevent="submitForm" class="p-8 bg-white shadow-lg rounded-lg">
        ...
        <div class="mb-6">
            ...
            <textarea id="message" v-model="formData.message" rows="4" required
                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-2"></textarea>
        </div>
