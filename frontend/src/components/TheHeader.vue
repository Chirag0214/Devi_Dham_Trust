  ...
  <nav class="hidden md:flex items-center space-x-4 md:space-x-5">
      ...
      <div class="flex items-center space-x-3">
        ...
        <button @click="mobileOpen = !mobileOpen" aria-label="Toggle menu"
          ...
          <svg v-if="!mobileOpen" xmlns="http://www.w3.org/2000/svg" class="h-6 w-20" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
          </svg>
          <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-6 w-20" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
